...
namespace Zigfu.KinectAudio
{
    ...
    public sealed partial class ZigKinectAudioSource : MonoBehaviour
    {
        ...
        public Boolean HasBeenInitialized { get; private set; }
        ...
        {
            if (verbose) { Debug.Log(ClassName + " :: OnFinishedInitializing"); }

            EventHandler handler = FinishedInitializing;
            if (handler != null)
            {
        ...
        public ZigAudioProcessingIntent initialAudioProcessingIntent = DefaultAudioProcessingIntent;
        ...
        public void ApplyInitialSettings()
        {
            ...
            AudioProcessingIntent = initialAudioProcessingIntent;

            if (AudioProcessingIntent == ZigAudioProcessingIntent.CaptureMutableAudio)
            {
        ...
        public Double BeamAngle
        {
            ...
            private set
            {
                ...
                {
                    if (verbose) { Debug.Log(ClassName + " :: Set BeamAngle to " + newAngle_deg); }
        ...
        public ZigBeamAngleMode BeamAngleMode
        {
            ...
            set
            {
                if (verbose) { Debug.Log(ClassName + " :: Set BeamAngleMode to " + value); }
        ...
        public Double SoundSourceAngle
        {
            ...
            private set
            {
                ...
                {
                    if (verbose) { Debug.Log(ClassName + " :: Set SoundSourceAngle to " + _soundSourceAngleInDegrees); }
        ...
        public Boolean AutomaticGainControlEnabled
        {
            ...
            set
            {
                if (verbose) { Debug.Log(ClassName + " :: Set AutomaticGainControlEnabled to " + value); }
        ...
        public Boolean NoiseSuppression
        {
            ...
            set
            {
                if (verbose) { Debug.Log(ClassName + " :: Set NoiseSuppression to " + value); }
        ...
        public ZigEchoCancellationMode EchoCancellationMode
        {
            ...
            set
            {
                if (verbose) { Debug.Log(ClassName + " :: Set EchoCancellationMode to " + value); }
        ...
        Boolean EvaluateHResult(Int32 hr)
        {
            if (hr < 0)
            {
                IntPtr ptr = AS_GetLastRecordedErrorMessage(true);
