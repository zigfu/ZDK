...
HRESULT KinectAudioStream::StartCapture()
{
    ...
    {
        StaticMediaBuffer *pBuf = new StaticMediaBuffer();
...
HRESULT KinectAudioStream::StopCapture()
{
    ...
    {
        StaticMediaBuffer* mediaBuffer = m_BufferPool.top();
        delete mediaBuffer;
        m_BufferPool.pop();
    }
...
STDMETHODIMP KinectAudioStream::Write(const void *,ULONG,ULONG *) { return E_NOTIMPL; }
STDMETHODIMP KinectAudioStream::SetSize(ULARGE_INTEGER) { return E_NOTIMPL; }
STDMETHODIMP KinectAudioStream::CopyTo(IStream *,ULARGE_INTEGER,ULARGE_INTEGER *,ULARGE_INTEGER *) { return E_NOTIMPL; }
STDMETHODIMP KinectAudioStream::Commit(DWORD) { return E_NOTIMPL; }
STDMETHODIMP KinectAudioStream::Revert() { return E_NOTIMPL; }
STDMETHODIMP KinectAudioStream::LockRegion(ULARGE_INTEGER,ULARGE_INTEGER,DWORD) { return E_NOTIMPL; }
STDMETHODIMP KinectAudioStream::UnlockRegion(ULARGE_INTEGER,ULARGE_INTEGER,DWORD) { return E_NOTIMPL; }
STDMETHODIMP KinectAudioStream::Stat(STATSTG *,DWORD) { return E_NOTIMPL; }
STDMETHODIMP KinectAudioStream::Clone(IStream **) { return E_NOTIMPL; }


// -------- Private KinectAudioStream Methods ---------

StaticMediaBuffer *KinectAudioStream::GetWriteBuffer()
{
    StaticMediaBuffer *pBuf = NULL;
...
void KinectAudioStream::ReleaseBuffer(StaticMediaBuffer* pBuffer)
{
    if (pBuffer != NULL)
    {
        EnterCriticalSection(&m_Lock);
...
void KinectAudioStream::ReleaseAllBuffers()
{
    ...
    {
        StaticMediaBuffer *pBuf = m_ReadBufferQueue.front();
        m_ReadBufferQueue.pop();
        ReleaseBuffer(pBuf);
    }
...
void KinectAudioStream::QueueCapturedBuffer(StaticMediaBuffer *pBuffer)
{
    EnterCriticalSection(&m_Lock);
...
DWORD WINAPI KinectAudioStream::CaptureThread()
{
    ...
    StaticMediaBuffer outputBuffer;
