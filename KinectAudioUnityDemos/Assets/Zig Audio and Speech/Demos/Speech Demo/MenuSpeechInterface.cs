...
public class MenuSpeechInterface : MonoBehaviour
{
    ...
    static Dictionary<MenuController.MenuPhaseEnum, ListeningModeEnum> _ListeningModeForMenuPhase = new Dictionary<MenuController.MenuPhaseEnum, ListeningModeEnum> 
    {
		{ MenuController.MenuPhaseEnum.PresentChoices,      ListeningModeEnum.ChoiceSelection },
		{ MenuController.MenuPhaseEnum.AskForConfirmation,  ListeningModeEnum.ChoiceConfirmation },
        { MenuController.MenuPhaseEnum.ShowResults,         ListeningModeEnum.Restart }
	};
    static public ListeningModeEnum GetListeningModeForMenuPhase(MenuController.MenuPhaseEnum menuPhase)
    {
    ...
    void MenuPhaseChanged_Handler(object sender, MenuController.MenuPhaseChanged_EventArgs e)
    {
    ...
    {
        MenuController.Choice choice;
        if (!MenuController.TryGetChoiceForString(choiceStr, out choice))
        {
